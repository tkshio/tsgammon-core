 ...
 *
 */
export function applyDicePipToPoints(board: BoardState,
    dicePip: DicePip,
    nodeBuilder: NodeBuilder,
    mark: number): [(pos: number) => (BoardStateNode | NoMove), number] {
    ...
    const nodesAndMarksForEachPoint: [(BoardStateNode | NoMove), number][] = board.points().map((_, index) => {
